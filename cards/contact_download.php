...
if($_SERVER['HTTP_HOST']=="localhost"){$connect=mysqli_connect("localhost","u500757179_mybude","Mybude@2021","u500757179_mybude") or die ('Database not available...');}else {$connect=mysqli_connect("localhost","u500757179_mybude","Mybude@2021","u500757179_mybude") or die ('Connection issue #567844 Error');}
