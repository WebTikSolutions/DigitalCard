...
<!----------------------copy from here ------------------------->
	...
	<div class="card" id="home">
			...
			<div class="dis_flex">
				...
				<?php if(!empty($row['d_whatsapp'])){echo '<a href="https://api.whatsapp.com/send?text=www.digicarddemo.site" target="_blank"><div class="link_btn"><i class="fa fa-whatsapp"></i> WhatsApp</div></a>';} ?>
			...
			<div class="dis_flex">
				<div class="share_wtsp">
					<form action="https://api.whatsapp.com/send" target="_blank"><input type="text"  name="phone" placeholder="WhatsApp Number with Country code	" value="+91"><input type="hidden" name="text" value="https://<?php echo $_SERVER['HTTP_HOST']; ?>/digicard/cards/preview_page.php?card_number=<?php echo $row['id']; ?>"><input type="submit" value="Share On WhatsApp"></form>
