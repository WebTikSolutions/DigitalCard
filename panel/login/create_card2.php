...
<!-------------------form ----------------------->	
		...
		<div class="input_box"><p>Position/Designation * </p><input type="text" name="d_position" maxlength="50" placeholder="Enter Position/Designation (Ex. Manager etc.)" value="<?php if(!empty($row['d_position'])){echo $row['d_position'];}?>" required></div>
