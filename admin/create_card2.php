...
<!-------------------form ----------------------->	
		...
		<div class="input_box"><p>About Us * </p><textarea type="text" name="d_about_us" maxlength="800" placeholder="About your company/business"  required><?php if(!empty($row['d_about_us'])){echo $row['d_about_us'];}?></textarea></div>
